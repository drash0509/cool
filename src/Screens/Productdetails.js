...
import favfilled from '../Assets//Images/favfilled.png';
      ...
      <div style={styles.container}>
        ...
        <div style={styles.detailsContainer}>
          ...
          <button
              style={{
                ...styles.button,
                backgroundColor: isAddToCartHovered ? 'white' : 'gray',
                color: isAddToCartHovered ? 'black' : 'white',
                border: isAddToCartHovered ? '1px solid black' : '0',
              }}
            ...
            <button
              style={{
                ...styles.button,
                backgroundColor: isBuyNowHovered ? 'white' : 'black',
                color: isBuyNowHovered ? 'black' : 'white',
                border: isBuyNowHovered ? '1px solid black' : '1px solid black',
              }}
